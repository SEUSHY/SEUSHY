...
<body>
	...
	<table>
		...
		<div style="text-align: center">
			...
			<form method="post" action="">
				<div>
			<p>审判状态：
				<select id="trial01" name="trial01" type="text" onchange="HaveLife()">
					<option>未预约</option>
					<option>已预约</option>
				</select>
			</p>
        ...
        FROM userinfo WHERE Life = '死' AND Trial_Condition NOT LIKE '已审判'  ";
	...
	?>
		...
		$name = $_POST[ "name01" ];
		$trial = $_POST[ "trial01" ];
		$sql = "UPDATE userinfo SET Trial_Condition = '$trial' WHERE Name = '$name'";
